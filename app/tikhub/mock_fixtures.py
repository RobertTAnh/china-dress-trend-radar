...
MOCK_VIDEOS: list[dict] = [
    _aweme("7100000000000000001", "黑色丝绒生日party小礼服", "法式小香风黑色丝绒生日party小礼服", "轻礼服衣橱", 1, 8200, 430, 210, 980, 185000),
    _aweme("7100000000000000002", "黑色丝绒生日party小礼服", "黑色丝绒收腰小礼服试穿", "小个子穿搭", 2, 5400, 190, 88, 640, 92000),
    ...
    _aweme("7100000000000000011", "蝴蝶结生日连衣裙", "重工钉珠蝴蝶结生日连衣裙", "ParisLook", 2, 11200, 640, 300, 1400, 205000),
    _aweme("7100000000000000012", "蝴蝶结生日连衣裙", "法式蝴蝶结一字肩生日连衣裙", "派对造型师", 9, 2300, 80, 28, 160, 36000),
    _aweme("7100000000000000013", "斜肩花苞连衣裙试穿", "白色斜肩花苞连衣裙试穿，短款显瘦", "小个子穿搭", 1, 8700, 390, 170, 860, 142000),
    _aweme("7100000000000000014", "斜肩花苞连衣裙试穿", "韩系斜肩花苞连衣裙上身分享", "裙装工作室", 16, 1900, 55, 18, 90, 27000),
    ...
    _aweme("7100000000000000019", "方领收腰蓬蓬连衣裙", "黑丝绒方领收腰蓬蓬连衣裙，赴宴约会都合适", "小个子造型", 4, 7600, 320, 140, 690, 128000),
    _aweme("7100000000000000020", "方领收腰蓬蓬连衣裙", "方领收腰蓬蓬连衣裙穿搭分享", "派对穿搭日记", 25, 900, 30, 9, 40, 12000),
    ...
    _aweme("7100000000000000023", "吊带礼服裙生日穿搭", "香槟色吊带网纱礼服裙生日穿搭更显白", "温柔衣橱", 14, 2800, 100, 35, 210, None),
...
CROSS_KEYWORD_LINKS = {
    ...
    "7100000000000000005": ["生日约会连衣裙", "法式连衣裙"],
    "7100000000000000015": ["气质小黑裙", "小个子连衣裙"],
    "7100000000000000011": ["蝴蝶结生日连衣裙", "生日约会连衣裙"],
}

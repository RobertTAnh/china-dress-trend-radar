...
MOCK_VIDEOS: list[dict] = [
    ...
    _aweme("7100000000000000011", "抹胸连衣裙试穿", "抹胸蝴蝶结连衣裙试穿露背设计", "ParisLook", 2, 11200, 640, 300, 1400, 205000),
    _aweme("7100000000000000012", "抹胸连衣裙试穿", "抹胸蝴蝶结连衣裙试穿搭配珍珠", "派对造型师", 9, 2300, 80, 28, 160, 36000),
    _aweme("7100000000000000013", "吊带连衣裙试穿", "吊带网纱连衣裙试穿收腰显瘦", "小个子穿搭", 1, 8700, 390, 170, 860, 142000),
    _aweme("7100000000000000014", "吊带连衣裙试穿", "吊带网纱连衣裙试穿分享", "裙装工作室", 16, 1900, 55, 18, 90, 27000),
    ...
    _aweme("7100000000000000023", "吊带连衣裙试穿", "香槟色吊带网纱连衣裙试穿更显白", "温柔衣橱", 14, 2800, 100, 35, 210, None),
...
CROSS_KEYWORD_LINKS = {
    ...
    "7100000000000000011": ["抹胸连衣裙试穿", "小众连衣裙"],
}

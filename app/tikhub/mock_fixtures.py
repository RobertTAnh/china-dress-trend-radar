...
MOCK_VIDEOS: list[dict] = [
    _aweme("7100000000000000001", "轻礼服女", "轻礼服女上身显瘦 #连衣裙穿搭", "轻礼服衣橱", 1, 8200, 430, 210, 980, 185000),
    _aweme("7100000000000000002", "轻礼服女", "黑色收腰轻礼服连衣裙试穿", "小个子穿搭", 2, 5400, 190, 88, 640, 92000),
    _aweme("7100000000000000003", "小众连衣裙", "小众连衣裙女新款分享", "设计师衣橱", 4, 12100, 760, 410, 1500, 240000),
    _aweme("7100000000000000004", "小众连衣裙", "短款小众设计连衣裙显高", "法式衣橱", 5, 3100, 120, 40, 280, None),
    _aweme("7100000000000000005", "生日战袍", "红色生日战袍连衣裙试穿", "生日穿搭日记", 1, 15600, 980, 620, 2100, 310000),
    _aweme("7100000000000000006", "生日战袍", "缎面生日战袍连衣裙细节", "派对女孩", 6, 2700, 95, 33, 190, 41000),
    ...
    _aweme("7100000000000000011", "抹胸连衣裙", "抹胸蝴蝶结连衣裙露背设计", "ParisLook", 2, 11200, 640, 300, 1400, 205000),
    _aweme("7100000000000000012", "抹胸连衣裙", "抹胸蝴蝶结连衣裙搭配珍珠", "派对造型师", 9, 2300, 80, 28, 160, 36000),
    _aweme("7100000000000000013", "吊带长裙", "吊带网纱长裙女收腰显瘦", "小个子穿搭", 1, 8700, 390, 170, 860, 142000),
    _aweme("7100000000000000014", "吊带长裙", "吊带网纱长裙女试穿分享", "裙装工作室", 16, 1900, 55, 18, 90, 27000),
    ...
    _aweme("7100000000000000017", "梨形身材连衣裙", "梨形身材显瘦连衣裙收腰细节", "梨形穿搭", 2, 17800, 1100, 780, 2400, 390000),
    _aweme("7100000000000000018", "梨形身材连衣裙", "梨形身材显瘦连衣裙日常也能穿", "质感女装", 11, 3600, 140, 52, 310, 54000),
    ...
    _aweme("7100000000000000021", "轻礼服女", "丝绒轻礼服连衣裙女冬季款", "轻礼服衣橱", 6, 4500, 160, 70, 400, 67000),
    _aweme("7100000000000000022", "小众连衣裙", "绿色小众设计感连衣裙女", "ParisLook", 7, 5100, 200, 90, 470, 79000),
    _aweme("7100000000000000023", "吊带长裙", "香槟色吊带网纱长裙女更显白", "温柔衣橱", 14, 2800, 100, 35, 210, None),
    _aweme("7100000000000000024", "生日战袍", "黑色生日战袍连衣裙女高级感", "生日衣橱", 40, 700, 18, 6, 25, 9000),
]

# Duplicate discovery: same video found by a second keyword.
CROSS_KEYWORD_LINKS = {
    "7100000000000000003": ["小众连衣裙", "轻礼服女"],
    "7100000000000000005": ["生日战袍", "轻礼服女"],
    "7100000000000000015": ["气质小黑裙", "小个子连衣裙"],
    "7100000000000000011": ["抹胸连衣裙", "小众连衣裙"],
}

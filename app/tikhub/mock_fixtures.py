...
MOCK_VIDEOS: list[dict] = [
    ...
    _aweme("7100000000000000011", "生日战袍试穿", "生日战袍试穿，抹胸蝴蝶结礼服裙露背设计", "ParisLook", 2, 11200, 640, 300, 1400, 205000),
    _aweme("7100000000000000012", "生日战袍试穿", "生日战袍试穿，抹胸礼服裙搭配珍珠", "派对造型师", 9, 2300, 80, 28, 160, 36000),
...
CROSS_KEYWORD_LINKS = {
    ...
    "7100000000000000011": ["生日战袍试穿", "小众连衣裙"],
}
